"""
PeRAM: Python adaptation of the Range-dependent Acoustic Model (RAM).
...
from peram.matrc import matrc
from peram.solve import solve
from peram.outpt import outpt
...
class PeRAM:
    ...
    def get_params(self, **kwargs):
        ...
        self._np = kwargs.get('np', PeRAM._np_default)
        ...
        self._dz = kwargs.get('dz', PeRAM._dzf * 1500 / self._freq)

        self._ndr = kwargs.get('ndr', PeRAM._ndr_default)
        self._ndz = kwargs.get('ndz', PeRAM._ndz_default)
        ...
        self._ns = kwargs.get('ns', PeRAM._ns_default)
        self._rs = kwargs.get('rs', self._rmax + self._dr)

        self._lyrw = kwargs.get('lyrw', PeRAM._lyrw_default)

        self._id = kwargs.get('id', PeRAM._id_default)
    ...
    def setup(self):
        ...
        self._z_sb = self._z_sb.astype(float) + self._z_ss[-1]  # Make seabed profiles relative to deepest water profile point - modified
